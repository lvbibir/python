...
'''
问题描述：
鬼谷子随意从2-99中选取了两个数(a,b)。他把这两个数的和(Sum)告诉了庞涓， 把这两个数的乘积(Pro)告诉了孙膑。但孙膑和庞涓彼此不知道对方得到的数。第二天， 庞涓很有自信的对孙膑说：虽然我不知道这两个数是什么，但我知道你一定也不知道。随后，孙膑说：那我知道了。庞涓说：那我也知道了。这两个数是什么？
...
def isSun(pro):
    '''
    第二步，传入的pro满足以下条件返回一组ab组合，否则False
    1. 可以拆分成若干组ab的乘积
